...
function _buildExcel (data) {
    ...
    var header = [
        ...
        {title: '书回时间', field: 'doc_date_feedback'},
        {title: '书回内容', field: 'doc_feedback'},
        {title: '网回时间', field: 'web_date_feedback'},
        {title: '网回内容', field: 'web_feedback'}
    ];
    var rowCount = 1;
    ...
    function _checkContents (field, rowData) {
        ...
        if (~'createtime comment_recv_date comment_date web_date_feedback doc_date_feedback'.indexOf(field)) {
            return value ? moment(value).format('YYYY/MM/DD') : '';
        } else if (~'content doc_feedback web_feedback'.indexOf(field)) {
